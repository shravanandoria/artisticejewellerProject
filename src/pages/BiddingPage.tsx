...
import React, { useState, useEffect, ChangeEventHandler, FormEvent, ChangeEvent, FormEventHandler } from 'react';
    ...
    <div className='my-6 '>
        <div className='flex items-center gap-x-3 '>
            ...
            <div className='text-xs laptop:text-sm'>
                <p>Listed for resell by <b>@ayatayas</b></p>
                <p>24th june 2022</p>
            </div>
        </div>
    </div>
...
const BiddingPage = () => {
    ...
    const { data: listing, isLoading, error } = useActiveListings(marketplace, {tokenId: 0});    
    ...
    return (
        <>
            {isLoading ? <div>loading....</div> : !listingInfo[0] ? "nft auction over" : 
            <div >
                {/* MODAL POPUP */}
                {modalOpen &&
                <div>
                ...
                <div className='p-8 tablet:flex tablet:justify-center tablet:space-x-16 laptop:px-32'>
                    ...
                    <div className='tablet:w-1/2 laptop:mb-10'>
                        ...
                        <div className='my-3 laptop:my-5'>
                            ...
                            <p className='text-xs text-gray-400 laptop:text-sm '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo, tempora, Lorem ipsum dolor sit amet.</p>
                        </div>
